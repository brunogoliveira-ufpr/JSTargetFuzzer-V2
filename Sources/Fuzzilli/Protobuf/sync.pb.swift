...
public struct Fuzzilli_Protobuf_Statistics {
  ...
  //JSTargetFuzzer
  public var sec_coverage: Double {
    get {return _storage._sec_coverage}
    set {_uniqueStorage()._sec_coverage = newValue}
  }

  public var sec_coverage_total: Double {
    get {return _storage._sec_coverage_total}
    set {_uniqueStorage()._sec_coverage_total = newValue}
  }
...
extension Fuzzilli_Protobuf_Statistics: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    ...
    16: .same(proto: "sec_coverage"),
    17: .same(proto: "sec_coverage_total"),
    18: .same(proto: "correctnessRate"),
    19: .same(proto: "timeoutRate"),
  ]
  ...
  fileprivate class _StorageClass {
    ...
    var _sec_coverage: Double = 0
    var _sec_coverage_total: Double = 0
    ...
    init(copying source: _StorageClass) {
      ...
      _sec_coverage = source._sec_coverage
      _sec_coverage_total = source._sec_coverage_total
  ...
  public static func ==(lhs: Fuzzilli_Protobuf_Statistics, rhs: Fuzzilli_Protobuf_Statistics) -> Bool {
    if lhs._storage !== rhs._storage {
      let storagesAreEqual: Bool = withExtendedLifetime((lhs._storage, rhs._storage)) { (_args: (_StorageClass, _StorageClass)) in
        ...
        if _storage._sec_coverage != rhs_storage._sec_coverage {return false}
        if _storage._sec_coverage_total != rhs_storage._sec_coverage_total {return false}
