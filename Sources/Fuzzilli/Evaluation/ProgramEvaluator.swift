...
public protocol ProgramEvaluator: Component {
    ...
    var isCovered: Bool { get }

    /// New property to track total security hits per edge
    
    var numEdges: Double { get }
    var numSecCov: Double { get }
    var numSecCovTotal: Double { get }
    //var numSecPerEdge: Double { get }
    //var numSecPerEdgeTotal: Double { get }
