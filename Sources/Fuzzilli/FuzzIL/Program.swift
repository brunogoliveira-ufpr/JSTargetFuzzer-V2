...
public final class Program {
    ...
    // [JST] Program Weight
    public var weight: Double = programWeight3 // Default weight is set to 1

    // [JST] Program SecCov Edge
    public var numSeccov: Double = 0
    ...
    public convenience init(code: Code, parent: Program? = nil, comments: ProgramComments = ProgramComments(), contributors: Contributors = Contributors(), weight: Double = programWeight3) {
        self.init(with: code)
