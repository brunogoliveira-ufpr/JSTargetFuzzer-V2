...
// Group 1: Loop and Condition Operators
public let loopAndConditionGenerators: [CodeGenerator] = [
    CodeGenerators.get("IfElseGenerator"),
    CodeGenerators.get("CompareWithIfElseGenerator"),
    CodeGenerators.get("SwitchBlockGenerator"),
    CodeGenerators.get("SwitchCaseGenerator"),
    CodeGenerators.get("SwitchDefaultCaseGenerator"),
    CodeGenerators.get("SwitchCaseBreakGenerator"),
    CodeGenerators.get("WhileLoopGenerator"),
    CodeGenerators.get("DoWhileLoopGenerator"),
    CodeGenerators.get("SimpleForLoopGenerator"),
    CodeGenerators.get("ComplexForLoopGenerator"),
    CodeGenerators.get("ForInLoopGenerator"),
    CodeGenerators.get("ForOfLoopGenerator"),
    CodeGenerators.get("ForOfWithDestructLoopGenerator"),
    CodeGenerators.get("RepeatLoopGenerator"),
    CodeGenerators.get("LoopBreakGenerator"),
    CodeGenerators.get("ContinueGenerator"),
    CodeGenerators.get("TryCatchGenerator"),
    CodeGenerators.get("ThrowGenerator"),
    CodeGenerators.get("EvalGenerator"),
    CodeGenerators.get("BlockStatementGenerator")
]


// Group 2: Math Operations
public let mathGenerators: [CodeGenerator] = [
    CodeGenerators.get("BinaryOperationGenerator"),
    CodeGenerators.get("UnaryOperationGenerator"),
    CodeGenerators.get("TernaryOperationGenerator"),
    CodeGenerators.get("UpdateGenerator"),
    CodeGenerators.get("ComparisonGenerator"),
    CodeGenerators.get("TypeTestGenerator"),
    CodeGenerators.get("InstanceOfGenerator"),
    CodeGenerators.get("InGenerator"),
    CodeGenerators.get("NumberComputationGenerator")
]


// Group 3: Read/Write Operations
public let readWriteGenerators: [CodeGenerator] = [
    CodeGenerators.get("PropertyRetrievalGenerator"),
    CodeGenerators.get("PropertyAssignmentGenerator"),
    CodeGenerators.get("PropertyUpdateGenerator"),
    CodeGenerators.get("PropertyRemovalGenerator"),
    CodeGenerators.get("ElementRetrievalGenerator"),
    CodeGenerators.get("ElementAssignmentGenerator"),
    CodeGenerators.get("ElementUpdateGenerator"),
    CodeGenerators.get("ElementRemovalGenerator"),
    CodeGenerators.get("ComputedPropertyRetrievalGenerator"),
    CodeGenerators.get("ComputedPropertyAssignmentGenerator"),
    CodeGenerators.get("ComputedPropertyUpdateGenerator"),
    CodeGenerators.get("PrivatePropertyRetrievalGenerator"),
    CodeGenerators.get("PrivatePropertyAssignmentGenerator"),
    CodeGenerators.get("PrivatePropertyUpdateGenerator"),
    CodeGenerators.get("PropertyConfigurationGenerator"),
    CodeGenerators.get("ElementConfigurationGenerator"),
    CodeGenerators.get("ComputedPropertyConfigurationGenerator"),
    CodeGenerators.get("PrivatePropertyRetrievalGenerator"),
    CodeGenerators.get("SuperPropertyRetrievalGenerator"),
    CodeGenerators.get("SuperPropertyAssignmentGenerator"),
    CodeGenerators.get("SuperPropertyUpdateGenerator"),
    CodeGenerators.get("WellKnownPropertyLoadGenerator"),
    CodeGenerators.get("WellKnownPropertyStoreGenerator"),
    CodeGenerators.get("PrototypeAccessGenerator"),
    CodeGenerators.get("PrototypeOverwriteGenerator"),
    CodeGenerators.get("CallbackPropertyGenerator"),
    CodeGenerators.get("LengthChangeGenerator"),
    CodeGenerators.get("ElementKindChangeGenerator"),
    CodeGenerators.get("DupGenerator"),
    CodeGenerators.get("ReassignmentGenerator"),
    CodeGenerators.get("NamedVariableLoadGenerator"),
    CodeGenerators.get("NamedVariableStoreGenerator"),
    CodeGenerators.get("NamedVariableDefinitionGenerator")
]


// Group 4: Function Call Generators
public let functionGenerators: [CodeGenerator] = [
    CodeGenerators.get("PlainFunctionGenerator"),
    CodeGenerators.get("ArrowFunctionGenerator"),
    CodeGenerators.get("GeneratorFunctionGenerator"),
    CodeGenerators.get("AsyncFunctionGenerator"),
    CodeGenerators.get("AsyncArrowFunctionGenerator"),
    CodeGenerators.get("AsyncGeneratorFunctionGenerator"),
    CodeGenerators.get("TrivialFunctionGenerator"),
    CodeGenerators.get("FunctionWithArgumentsAccessGenerator"),
    CodeGenerators.get("ThisGenerator"),
    CodeGenerators.get("ArgumentsAccessGenerator"),
    CodeGenerators.get("MethodCallGenerator"),
    CodeGenerators.get("MethodCallWithSpreadGenerator"),
    CodeGenerators.get("ComputedMethodCallGenerator"),
    CodeGenerators.get("ComputedMethodCallWithSpreadGenerator"),
    CodeGenerators.get("FunctionCallGenerator"),
    CodeGenerators.get("ConstructorCallGenerator"),
    CodeGenerators.get("FunctionCallWithSpreadGenerator"),
    CodeGenerators.get("ConstructorCallWithSpreadGenerator"),
    CodeGenerators.get("SubroutineReturnGenerator"),
    CodeGenerators.get("YieldGenerator"),
    CodeGenerators.get("AwaitGenerator"),
    CodeGenerators.get("SuperMethodCallGenerator"),
    CodeGenerators.get("PrivateMethodCallGenerator"),
    CodeGenerators.get("MethodCallWithDifferentThisGenerator"),
    CodeGenerators.get("ImitationGenerator"),
    CodeGenerators.get("WeirdClassGenerator"),
    CodeGenerators.get("ProxyGenerator"),
    CodeGenerators.get("PromiseGenerator")
]


// Group 5: Object and Array Generators
public let objectArrayGenerators: [CodeGenerator] = [
    CodeGenerators.get("ArrayGenerator"),
    CodeGenerators.get("IntArrayGenerator"),
    CodeGenerators.get("FloatArrayGenerator"),
    CodeGenerators.get("ObjectLiteralGenerator"),
    CodeGenerators.get("ObjectLiteralPropertyGenerator"),
    CodeGenerators.get("ObjectLiteralElementGenerator"),
    CodeGenerators.get("ObjectLiteralComputedPropertyGenerator"),
    CodeGenerators.get("ObjectLiteralCopyPropertiesGenerator"),
    CodeGenerators.get("ObjectLiteralPrototypeGenerator"),
    CodeGenerators.get("ObjectLiteralMethodGenerator"),
    CodeGenerators.get("ObjectLiteralComputedMethodGenerator"),
    CodeGenerators.get("ObjectLiteralGetterGenerator"),
    CodeGenerators.get("ObjectLiteralSetterGenerator"),
    CodeGenerators.get("ClassDefinitionGenerator"),
    CodeGenerators.get("ClassConstructorGenerator"),
    CodeGenerators.get("ClassInstancePropertyGenerator"),
    CodeGenerators.get("ClassInstanceElementGenerator"),
    CodeGenerators.get("ClassInstanceComputedPropertyGenerator"),
    CodeGenerators.get("ClassInstanceMethodGenerator"),
    CodeGenerators.get("ClassInstanceGetterGenerator"),
    CodeGenerators.get("ClassInstanceSetterGenerator"),
    CodeGenerators.get("ClassStaticPropertyGenerator"),
    CodeGenerators.get("ClassStaticElementGenerator"),
    CodeGenerators.get("ClassStaticComputedPropertyGenerator"),
    CodeGenerators.get("ClassStaticMethodGenerator"),
    CodeGenerators.get("ClassPrivateInstancePropertyGenerator"),
    CodeGenerators.get("ClassPrivateInstanceMethodGenerator"),
    CodeGenerators.get("ClassPrivateStaticPropertyGenerator"),
    CodeGenerators.get("ClassPrivateStaticMethodGenerator"),
    CodeGenerators.get("ArrayWithSpreadGenerator"),
    CodeGenerators.get("BuiltinObjectInstanceGenerator"),
    CodeGenerators.get("TypedArrayGenerator"),
    CodeGenerators.get("RegExpGenerator"),
    CodeGenerators.get("ProxyGenerator"),
    CodeGenerators.get("WithStatementGenerator"),
    CodeGenerators.get("DestructArrayGenerator"),
    CodeGenerators.get("DestructArrayAndReassignGenerator"),
    CodeGenerators.get("DestructObjectGenerator"),
    CodeGenerators.get("DestructObjectAndReassignGenerator"),
    CodeGenerators.get("ResizableArrayBufferGenerator"),
    CodeGenerators.get("GrowableSharedArrayBufferGenerator"),
    CodeGenerators.get("FastToSlowPropertiesGenerator"),
    CodeGenerators.get("IteratorGenerator")
]

public let essentialGenerators: [CodeGenerator] = [
    CodeGenerators.get("IntegerGenerator") // Essential generator always active
]
