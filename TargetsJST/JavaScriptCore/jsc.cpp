...
extern "C" void __sanitizer_cov_trace_pc_guard(uint32_t *guard) {
    ...
    void *PC = __builtin_return_address(0); //0x5555565df776


    void *targetStart = (void*)0x555556cc6d40;
    void *targetEnd = (void*)0x555556cfa770;

    __shmem->edges[index / 8] |= 1 << (index % 8);


        if((((uintptr_t)PC < (uintptr_t)targetEnd) && (((uintptr_t)PC >= (uintptr_t)targetStart))) {//|| (((uintptr_t)PC < (uintptr_t)LowerEnd) && ((uintptr_t)PC >= (uintptr_t)LowerStart))){
