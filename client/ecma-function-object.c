 ...
 *         false - otherwise
 */
bool ecma_op_is_callable(ecma_value_t value) /**< ecma value */
{
...
ecma_object_check_constructor(ecma_object_t *obj_p) /**< ecma object */
{
    ...
    JERRY_ASSERT(type == ECMA_OBJECT_TYPE_NATIVE_FUNCTION || type == ECMA_OBJECT_TYPE_BUILT_IN_FUNCTION || type == ECMA_OBJECT_TYPE_CONSTRUCTOR_FUNCTION);
 ...
 *         false - otherwise
 */
bool ecma_is_constructor(ecma_value_t value) /**< ecma value */
{
...
{
    JERRY_ASSERT(ecma_get_object_type(object_p) == ECMA_OBJECT_TYPE_FUNCTION || ecma_get_object_type(object_p) == ECMA_OBJECT_TYPE_NATIVE_FUNCTION);
                                                  ...
                                                  ecma_string_t *property_name_p) /**< property name */
{
    ...
    if (ecma_compare_ecma_string_to_magic_id(property_name_p, LIT_MAGIC_STRING_PROTOTYPE) && ecma_get_object_type(object_p) == ECMA_OBJECT_TYPE_FUNCTION)
    {
    ...
    if (is_arguments || ecma_compare_ecma_string_to_magic_id(property_name_p, LIT_MAGIC_STRING_CALLER))
    {
        ...
        if (!(bytecode_data_p->status_flags & CBC_CODE_FLAGS_STRICT_MODE) && CBC_FUNCTION_GET_TYPE(bytecode_data_p->status_flags) == CBC_FUNCTION_NORMAL)
        {
            ecma_property_t *value_prop_p;
 ...
 */
void ecma_op_function_delete_built_in_property(ecma_object_t *object_p,        /**< object */
                                               ecma_string_t *property_name_p) /**< property name */
{
    ecma_extended_object_t *ext_func_p = (ecma_extended_object_t *)object_p;
 ...
 */
void ecma_op_bound_function_delete_built_in_property(ecma_object_t *object_p,        /**< object */
                                                     ecma_string_t *property_name_p) /**< property name */
{
 ...
 *          ecma_op_function_try_to_lazy_instantiate_property
 */
void ecma_op_function_list_lazy_property_names(ecma_object_t *object_p,                 /**< functionobject */
                                               ...
                                               jerry_property_filter_t filter)          /**< property name filter options */
{
    ...
    if (CBC_FUNCTION_GET_TYPE(bytecode_data_p->status_flags) != CBC_FUNCTION_CONSTRUCTOR && !ECMA_GET_SECOND_BIT_FROM_POINTER_TAG(ext_func_p->u.function.scope_cp))
    {
    ...
    if (!CBC_FUNCTION_HAS_PROTOTYPE(bytecode_data_p->status_flags) || (CBC_FUNCTION_GET_TYPE(bytecode_data_p->status_flags) == CBC_FUNCTION_CONSTRUCTOR))
    {
        return;
    }
 ...
 *          ecma_op_external_function_try_to_lazy_instantiate_property
 */
void ecma_op_external_function_list_lazy_property_names(ecma_object_t *object_p,                 /**< function object */
                                                        ecma_collection_t *prop_names_p,         /**< prop name collection */
                                                        ecma_property_counter_t *prop_counter_p, /**< property counters */
 ...
 *          ecma_op_bound_function_try_to_lazy_instantiate_property
 */
void ecma_op_bound_function_list_lazy_property_names(ecma_object_t *object_p,                 /**< bound function object*/
                                                     ecma_collection_t *prop_names_p,         /**< prop name collection */
                                                     ecma_property_counter_t *prop_counter_p, /**< property counters */
                                                     jerry_property_filter_t filter)          /**< property name filter options */
{
